...
const IconSkipForwardCircle: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-skip-forward-circle") } { ...props }>
...
export default IconSkipForwardCircle;
