...
const IconTruckFlatbed: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-truck-flatbed") } { ...props }>
...
export default IconTruckFlatbed;
