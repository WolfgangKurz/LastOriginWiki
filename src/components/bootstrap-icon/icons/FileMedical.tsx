...
const IconFileMedical: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-medical") } { ...props }>
...
export default IconFileMedical;
