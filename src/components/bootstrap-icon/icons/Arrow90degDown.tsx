...
const IconArrow90degDown: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-arrow-90deg-down") } { ...props }>
...
export default IconArrow90degDown;
