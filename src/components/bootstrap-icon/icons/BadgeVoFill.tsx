...
const IconBadgeVoFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-badge-vo-fill") } { ...props }>
...
export default IconBadgeVoFill;
