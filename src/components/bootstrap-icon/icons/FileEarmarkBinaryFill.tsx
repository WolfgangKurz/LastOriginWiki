...
const IconFileEarmarkBinaryFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-binary-fill") } { ...props }>
...
export default IconFileEarmarkBinaryFill;
