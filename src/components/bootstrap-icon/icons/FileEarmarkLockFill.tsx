...
const IconFileEarmarkLockFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-lock-fill") } { ...props }>
...
export default IconFileEarmarkLockFill;
