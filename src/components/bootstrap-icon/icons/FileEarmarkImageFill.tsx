...
const IconFileEarmarkImageFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-image-fill") } { ...props }>
...
export default IconFileEarmarkImageFill;
