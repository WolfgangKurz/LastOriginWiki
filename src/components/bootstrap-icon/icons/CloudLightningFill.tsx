...
const IconCloudLightningFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-cloud-lightning-fill") } { ...props }>
...
export default IconCloudLightningFill;
