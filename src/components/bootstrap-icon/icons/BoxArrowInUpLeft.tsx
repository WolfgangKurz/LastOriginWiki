...
const IconBoxArrowInUpLeft: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-box-arrow-in-up-left") } { ...props }>
...
export default IconBoxArrowInUpLeft;
