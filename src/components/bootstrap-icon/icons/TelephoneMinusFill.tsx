...
const IconTelephoneMinusFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-telephone-minus-fill") } { ...props }>
...
export default IconTelephoneMinusFill;
