...
const IconLayoutSidebarInsetReverse: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-layout-sidebar-inset-reverse") } { ...props }>
...
export default IconLayoutSidebarInsetReverse;
