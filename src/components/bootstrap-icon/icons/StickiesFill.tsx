...
const IconStickiesFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-stickies-fill") } { ...props }>
...
export default IconStickiesFill;
