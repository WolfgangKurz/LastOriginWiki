...
const IconSortNumericUpAlt: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-sort-numeric-up-alt") } { ...props }>
...
export default IconSortNumericUpAlt;
