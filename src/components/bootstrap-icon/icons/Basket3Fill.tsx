...
const IconBasket3Fill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-basket3-fill") } { ...props }>
...
export default IconBasket3Fill;
