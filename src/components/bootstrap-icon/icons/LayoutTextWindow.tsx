...
const IconLayoutTextWindow: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-layout-text-window") } { ...props }>
...
export default IconLayoutTextWindow;
