...
const IconBadgeWcFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-badge-wc-fill") } { ...props }>
...
export default IconBadgeWcFill;
