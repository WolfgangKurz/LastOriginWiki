...
const IconBadgeAdFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-badge-ad-fill") } { ...props }>
...
export default IconBadgeAdFill;
