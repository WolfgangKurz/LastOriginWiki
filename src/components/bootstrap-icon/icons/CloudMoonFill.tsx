...
const IconCloudMoonFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-cloud-moon-fill") } { ...props }>
...
export default IconCloudMoonFill;
