...
const IconSkipForwardBtn: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-skip-forward-btn") } { ...props }>
...
export default IconSkipForwardBtn;
