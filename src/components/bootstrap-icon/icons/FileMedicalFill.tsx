...
const IconFileMedicalFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-medical-fill") } { ...props }>
...
export default IconFileMedicalFill;
