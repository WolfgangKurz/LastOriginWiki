...
const IconPatchMinusFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-patch-minus-fill") } { ...props }>
...
export default IconPatchMinusFill;
