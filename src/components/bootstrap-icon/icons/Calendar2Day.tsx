...
const IconCalendar2Day: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-calendar2-day") } { ...props }>
...
export default IconCalendar2Day;
