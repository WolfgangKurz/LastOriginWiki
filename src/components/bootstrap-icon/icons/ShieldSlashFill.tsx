...
const IconShieldSlashFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-shield-slash-fill") } { ...props }>
...
export default IconShieldSlashFill;
