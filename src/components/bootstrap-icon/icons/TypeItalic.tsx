...
const IconTypeItalic: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-type-italic") } { ...props }>
