...
const IconCloudMinusFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-cloud-minus-fill") } { ...props }>
...
export default IconCloudMinusFill;
