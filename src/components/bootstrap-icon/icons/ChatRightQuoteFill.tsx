...
const IconChatRightQuoteFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-chat-right-quote-fill") } { ...props }>
...
export default IconChatRightQuoteFill;
