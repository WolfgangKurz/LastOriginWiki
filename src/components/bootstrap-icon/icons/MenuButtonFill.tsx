...
const IconMenuButtonFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-menu-button-fill") } { ...props }>
...
export default IconMenuButtonFill;
