...
const IconGrid3x2Gap: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-grid-3x2-gap") } { ...props }>
