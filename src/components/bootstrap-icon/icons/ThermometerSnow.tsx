...
const IconThermometerSnow: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-thermometer-snow") } { ...props }>
...
export default IconThermometerSnow;
