...
const IconFileBarGraphFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-bar-graph-fill") } { ...props }>
...
export default IconFileBarGraphFill;
