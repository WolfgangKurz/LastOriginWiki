...
const IconMenuAppFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-menu-app-fill") } { ...props }>
...
export default IconMenuAppFill;
