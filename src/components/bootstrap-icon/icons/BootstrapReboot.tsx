...
const IconBootstrapReboot: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-bootstrap-reboot") } { ...props }>
...
export default IconBootstrapReboot;
