...
const IconCloudSleetFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-cloud-sleet-fill") } { ...props }>
...
export default IconCloudSleetFill;
