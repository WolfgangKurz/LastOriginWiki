...
const IconBlockquoteRight: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-blockquote-right") } { ...props }>
...
export default IconBlockquoteRight;
