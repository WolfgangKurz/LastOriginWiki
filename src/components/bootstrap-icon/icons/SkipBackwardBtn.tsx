...
const IconSkipBackwardBtn: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-skip-backward-btn") } { ...props }>
...
export default IconSkipBackwardBtn;
