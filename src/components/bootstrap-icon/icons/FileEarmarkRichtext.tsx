...
const IconFileEarmarkRichtext: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-richtext") } { ...props }>
...
export default IconFileEarmarkRichtext;
