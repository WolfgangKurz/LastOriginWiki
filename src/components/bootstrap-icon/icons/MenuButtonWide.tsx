...
const IconMenuButtonWide: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-menu-button-wide") } { ...props }>
...
export default IconMenuButtonWide;
