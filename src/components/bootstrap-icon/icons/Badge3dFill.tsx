...
const IconBadge3dFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-badge-3d-fill") } { ...props }>
...
export default IconBadge3dFill;
