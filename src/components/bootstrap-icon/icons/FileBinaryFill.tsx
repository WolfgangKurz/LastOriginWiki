...
const IconFileBinaryFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-binary-fill") } { ...props }>
...
export default IconFileBinaryFill;
