...
const IconBagDashFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-bag-dash-fill") } { ...props }>
...
export default IconBagDashFill;
