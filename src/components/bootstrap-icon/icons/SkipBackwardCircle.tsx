...
const IconSkipBackwardCircle: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-skip-backward-circle") } { ...props }>
...
export default IconSkipBackwardCircle;
