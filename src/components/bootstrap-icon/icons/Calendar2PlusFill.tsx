...
const IconCalendar2PlusFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-calendar2-plus-fill") } { ...props }>
...
export default IconCalendar2PlusFill;
