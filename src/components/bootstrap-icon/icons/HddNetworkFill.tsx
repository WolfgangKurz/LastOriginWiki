...
const IconHddNetworkFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-hdd-network-fill") } { ...props }>
...
export default IconHddNetworkFill;
