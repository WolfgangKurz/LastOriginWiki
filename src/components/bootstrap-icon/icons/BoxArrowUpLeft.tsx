...
const IconBoxArrowUpLeft: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-box-arrow-up-left") } { ...props }>
...
export default IconBoxArrowUpLeft;
