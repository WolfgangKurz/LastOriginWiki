...
const IconHeptagonFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-heptagon-fill") } { ...props }>
...
export default IconHeptagonFill;
