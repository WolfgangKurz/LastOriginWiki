...
const IconPatchExclamation: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-patch-exclamation") } { ...props }>
...
export default IconPatchExclamation;
