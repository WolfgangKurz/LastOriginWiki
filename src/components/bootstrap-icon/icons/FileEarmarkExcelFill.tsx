...
const IconFileEarmarkExcelFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-excel-fill") } { ...props }>
...
export default IconFileEarmarkExcelFill;
