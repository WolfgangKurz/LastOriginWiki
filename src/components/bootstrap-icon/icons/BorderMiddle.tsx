...
const IconBorderMiddle: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-border-middle") } { ...props }>
...
export default IconBorderMiddle;
