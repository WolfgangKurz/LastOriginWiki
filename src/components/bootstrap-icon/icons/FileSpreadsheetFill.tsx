...
const IconFileSpreadsheetFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-spreadsheet-fill") } { ...props }>
...
export default IconFileSpreadsheetFill;
