...
const IconCloudLightningRain: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-cloud-lightning-rain") } { ...props }>
...
export default IconCloudLightningRain;
