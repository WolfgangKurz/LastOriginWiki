...
const IconChevronBarDown: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-chevron-bar-down") } { ...props }>
...
export default IconChevronBarDown;
