...
const IconDiagram2Fill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-diagram-2-fill") } { ...props }>
...
export default IconDiagram2Fill;
