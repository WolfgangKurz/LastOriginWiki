...
const IconCameraVideoOffFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-camera-video-off-fill") } { ...props }>
...
export default IconCameraVideoOffFill;
