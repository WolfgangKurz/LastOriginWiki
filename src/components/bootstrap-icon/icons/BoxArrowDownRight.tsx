...
const IconBoxArrowDownRight: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-box-arrow-down-right") } { ...props }>
...
export default IconBoxArrowDownRight;
