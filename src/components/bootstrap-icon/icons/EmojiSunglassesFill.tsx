...
const IconEmojiSunglassesFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-emoji-sunglasses-fill") } { ...props }>
...
export default IconEmojiSunglassesFill;
