...
const IconFileEarmarkCheckFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-check-fill") } { ...props }>
...
export default IconFileEarmarkCheckFill;
