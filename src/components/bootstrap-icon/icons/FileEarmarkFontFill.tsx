...
const IconFileEarmarkFontFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-font-fill") } { ...props }>
...
export default IconFileEarmarkFontFill;
