...
const IconFileRichtext: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-richtext") } { ...props }>
...
export default IconFileRichtext;
