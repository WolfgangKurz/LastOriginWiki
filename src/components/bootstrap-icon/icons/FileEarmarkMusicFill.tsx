...
const IconFileEarmarkMusicFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-music-fill") } { ...props }>
...
export default IconFileEarmarkMusicFill;
