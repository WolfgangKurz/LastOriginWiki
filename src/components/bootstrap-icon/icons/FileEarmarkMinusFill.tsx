...
const IconFileEarmarkMinusFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-minus-fill") } { ...props }>
...
export default IconFileEarmarkMinusFill;
