...
const IconLightbulbOffFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-lightbulb-off-fill") } { ...props }>
...
export default IconLightbulbOffFill;
