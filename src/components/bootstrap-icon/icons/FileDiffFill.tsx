...
const IconFileDiffFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-diff-fill") } { ...props }>
...
export default IconFileDiffFill;
