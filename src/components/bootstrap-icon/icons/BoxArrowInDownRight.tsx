...
const IconBoxArrowInDownRight: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-box-arrow-in-down-right") } { ...props }>
...
export default IconBoxArrowInDownRight;
