...
const IconMinecartLoaded: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-minecart-loaded") } { ...props }>
...
export default IconMinecartLoaded;
