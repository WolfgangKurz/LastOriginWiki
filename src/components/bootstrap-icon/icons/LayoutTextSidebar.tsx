...
const IconLayoutTextSidebar: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-layout-text-sidebar") } { ...props }>
...
export default IconLayoutTextSidebar;
