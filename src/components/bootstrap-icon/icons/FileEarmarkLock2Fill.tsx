...
const IconFileEarmarkLock2Fill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-lock2-fill") } { ...props }>
...
export default IconFileEarmarkLock2Fill;
