...
const IconCloudFog2Fill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-cloud-fog2-fill") } { ...props }>
...
export default IconCloudFog2Fill;
