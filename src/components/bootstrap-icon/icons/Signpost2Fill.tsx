...
const IconSignpost2Fill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-signpost-2-fill") } { ...props }>
...
export default IconSignpost2Fill;
