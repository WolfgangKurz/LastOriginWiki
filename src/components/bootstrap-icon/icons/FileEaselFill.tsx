...
const IconFileEaselFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-easel-fill") } { ...props }>
...
export default IconFileEaselFill;
