...
const IconFileEarmarkEaselFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-easel-fill") } { ...props }>
...
export default IconFileEarmarkEaselFill;
