...
const IconCalendar2MinusFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-calendar2-minus-fill") } { ...props }>
...
export default IconCalendar2MinusFill;
