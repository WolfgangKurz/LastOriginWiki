...
const IconLayerBackward: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-layer-backward") } { ...props }>
...
export default IconLayerBackward;
