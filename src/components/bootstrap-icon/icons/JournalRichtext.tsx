...
const IconJournalRichtext: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-journal-richtext") } { ...props }>
...
export default IconJournalRichtext;
