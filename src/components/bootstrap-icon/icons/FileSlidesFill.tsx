...
const IconFileSlidesFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-slides-fill") } { ...props }>
...
export default IconFileSlidesFill;
