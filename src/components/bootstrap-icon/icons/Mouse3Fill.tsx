...
const IconMouse3Fill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-mouse3-fill") } { ...props }>
