...
const IconFileEarmarkMusic: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-music") } { ...props }>
...
export default IconFileEarmarkMusic;
