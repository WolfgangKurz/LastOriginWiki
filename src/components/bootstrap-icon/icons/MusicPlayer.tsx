...
const IconMusicPlayer: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-music-player") } { ...props }>
...
export default IconMusicPlayer;
