...
const IconFileEarmarkPostFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-post-fill") } { ...props }>
...
export default IconFileEarmarkPostFill;
