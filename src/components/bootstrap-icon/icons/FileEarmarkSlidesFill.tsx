...
const IconFileEarmarkSlidesFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-slides-fill") } { ...props }>
...
export default IconFileEarmarkSlidesFill;
