...
const IconCalendar2Month: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-calendar2-month") } { ...props }>
...
export default IconCalendar2Month;
