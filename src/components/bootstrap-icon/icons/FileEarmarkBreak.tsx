...
const IconFileEarmarkBreak: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-break") } { ...props }>
...
export default IconFileEarmarkBreak;
