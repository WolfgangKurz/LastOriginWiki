...
const IconDistributeHorizontal: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-distribute-horizontal") } { ...props }>
...
export default IconDistributeHorizontal;
