...
const IconReceiptCutoff: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-receipt-cutoff") } { ...props }>
...
export default IconReceiptCutoff;
