...
const IconEmojiLaughingFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-emoji-laughing-fill") } { ...props }>
...
export default IconEmojiLaughingFill;
