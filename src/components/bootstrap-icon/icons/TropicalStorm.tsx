...
const IconTropicalStorm: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-tropical-storm") } { ...props }>
...
export default IconTropicalStorm;
