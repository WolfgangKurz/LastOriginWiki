...
const IconBackspaceReverse: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-backspace-reverse") } { ...props }>
...
export default IconBackspaceReverse;
