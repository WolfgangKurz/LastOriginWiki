...
const IconFileFontFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-font-fill") } { ...props }>
...
export default IconFileFontFill;
