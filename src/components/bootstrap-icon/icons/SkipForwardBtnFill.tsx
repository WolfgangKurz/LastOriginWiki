...
const IconSkipForwardBtnFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-skip-forward-btn-fill") } { ...props }>
...
export default IconSkipForwardBtnFill;
