...
const IconCapslockFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-capslock-fill") } { ...props }>
...
export default IconCapslockFill;
