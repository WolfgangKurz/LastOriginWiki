...
const IconExclamationOctagon: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-exclamation-octagon") } { ...props }>
...
export default IconExclamationOctagon;
