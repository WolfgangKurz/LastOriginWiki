...
const IconSuitSpadeFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-suit-spade-fill") } { ...props }>
...
export default IconSuitSpadeFill;
