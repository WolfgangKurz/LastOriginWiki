...
const IconHandThumbsUpFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-hand-thumbs-up-fill") } { ...props }>
...
export default IconHandThumbsUpFill;
