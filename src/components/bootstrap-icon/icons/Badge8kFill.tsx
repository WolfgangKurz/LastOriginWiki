...
const IconBadge8kFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-badge-8k-fill") } { ...props }>
...
export default IconBadge8kFill;
