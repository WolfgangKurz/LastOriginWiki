...
const IconChatSquareQuoteFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-chat-square-quote-fill") } { ...props }>
...
export default IconChatSquareQuoteFill;
