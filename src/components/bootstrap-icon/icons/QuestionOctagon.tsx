...
const IconQuestionOctagon: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-question-octagon") } { ...props }>
...
export default IconQuestionOctagon;
