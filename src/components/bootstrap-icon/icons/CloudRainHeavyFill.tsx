...
const IconCloudRainHeavyFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-cloud-rain-heavy-fill") } { ...props }>
...
export default IconCloudRainHeavyFill;
