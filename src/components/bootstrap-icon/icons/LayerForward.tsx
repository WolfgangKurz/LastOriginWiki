...
const IconLayerForward: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-layer-forward") } { ...props }>
...
export default IconLayerForward;
