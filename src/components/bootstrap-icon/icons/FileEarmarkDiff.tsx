...
const IconFileEarmarkDiff: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-diff") } { ...props }>
...
export default IconFileEarmarkDiff;
