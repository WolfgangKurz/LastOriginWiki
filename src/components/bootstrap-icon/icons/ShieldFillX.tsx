...
const IconShieldFillX: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-shield-fill-x") } { ...props }>
...
export default IconShieldFillX;
