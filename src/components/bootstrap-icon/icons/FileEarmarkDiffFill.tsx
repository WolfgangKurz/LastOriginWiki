...
const IconFileEarmarkDiffFill: FunctionalComponent<IconProps> = ({ class: _class, ...props }) =>
	<IconBase class={ BuildClass(_class, "bi-file-earmark-diff-fill") } { ...props }>
...
export default IconFileEarmarkDiffFill;
