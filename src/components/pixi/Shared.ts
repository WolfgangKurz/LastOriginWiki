...
export default class Shared {
	...
	public get renderTexture (): RenderTexture { return this._renderTexture; }
	...
	private constructor () { // new guard
		this._renderTexture = RenderTexture.create({ width: 1, height: 1 });
	}
	...
	public static RenderableObjects (root: Container): Container[] {
		...
		// 		target.children.forEach((c: Container) => {
		...
		// 	cur.childs
		// 		.sort((a, b) => a.target.zIndex - b.target.zIndex)
