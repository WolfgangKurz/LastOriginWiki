			...
			{ OldStore.ConnectDirect(
				...
				({
					...
					function FillSourceFilters (value: boolean): void {
						...
						if (value !== Filters.Source.InfiniteWar) toggleEquipSourceInfiniteWar();
						...
						return Object.keys(group)
							...
							.filter(x => {
								...
								if (
									...
									sources.some(y => y.IsAltiteExchange || y.IsInfiniteWar)
								) return true;
								...
								if (Filters.Source.EventExchange && sources.some(y => y.IsEvent && y.IsExchange && y.EventId === CurrentEvent))
									return true;
								if (Filters.Source.OldEventExchange && sources.some(y => y.IsEvent && y.IsExchange && y.EventId !== CurrentEvent))
									return true;
									...
									<div class="col-12 col-md">
										...
										<div class="btn-group mx-1 mb-1">
											<button
												...
												onClick={ toggleEquipSourceGeneral }
											>
										...
										<div class="btn-group mx-1 mb-1">
											...
											<button
												...
												onClick={ toggleEquipSourceInfiniteWar }
											>
