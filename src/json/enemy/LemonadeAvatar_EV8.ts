export default {
  ...
  "skills": [
    ...
    {
      "key": "Skill_MP_LemonadeAvatar_N_2",
      "name": "주인님을 위하여",
      "icon": "Command",
      "desc": "기동형 아군의 AP를 상승시키고 전투 속행 효과를 부여합니다. 대상의 공격력 / 방어력을 5라운드 동안 증가시킵니다. ",
      "passive": false,
      "type": 0,
      "target": "team",
      "buff": {
    ...
    {
      "key": "Skill_MP_LemonadeAvatar_EV8_5",
      "name": "공간 이동",
      "icon": "WideLightning",
      "desc": "모든 아군 사망 후 <주인님을 위하여> 스킬 사용 시 연결을 해제하고 다른 공간으로 이동합니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
