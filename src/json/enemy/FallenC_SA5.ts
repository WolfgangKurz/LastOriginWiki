export default {
  ...
  "skills": [
    ...
    {
      "key": "Skill_MP_FallenC_SA5_5",
      "name": "출력 한계 해제",
      "icon": "SelfAtkBuff",
      "desc": "라운드 개시 시, <출력 증폭>이 5중첩 이상인 상태라면 방어막 / 피해 감소 효과를 무시하며 방어 관통 효과가 부여 됩니다. <출력 한계 해제> 상태에서 화염 공격에 피격 시 행동력이 감소합니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
