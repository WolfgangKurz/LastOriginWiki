export default {
  ...
  "skills": [
    {
      "key": "Skill_MP_BigChickS_N_1",
      "name": "방패 연타",
      "icon": "ShieldWall",
      "desc": "방패 연타로 대상에게 {0} 피해를 줍니다. 대상이 이동 불가 상태면 피해량이 증가하며, 높은 확률로 행동 불가 상태로 만듭니다.",
      "passive": false,
      "type": 0,
      "target": "enemy",
      "buff": {
