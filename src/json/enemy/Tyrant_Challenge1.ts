  ...
  "skills": [
    {
      ...
      "name": "타이런트 바이트",
      "icon": "AssaultAttack",
      "desc": "대상을 물어뜯어 {0} 보호 무시 피해를 주고, 2라운드 동안 방어력을 낮춥니다. 대상의 현재 HP%가 낮을수록 피해량이 증가하며, <포식자> 중첩이 1 증가합니다. 자신의 HP가 50% 이상이면, 대상의 피해 감소 효과를 해제합니다.",
      "passive": false,
      "type": 0,
      "target": "enemy",
      "buff": {
    ...
    },
    {
      ...
      "name": "먹잇감 탐색",
      "icon": "SelfAtkBuff",
      "desc": "라운드 개시 시, HP의 비율에 따라 새로운 먹잇감을 찾고 속성 공격에 피격 시, 일시적으로 먹잇감을 변경하고 라운드 개시 시, 아군 필드에 혼자 남았을 시, 먹잇감 독식 상태가 됩니다. 또한 먹잇감에 집중해 피격 시, 자신에게 적용된 도발 효과를 해제합니다.\n먹잇감 (중장형) : HP가 100%~60%일 경우, 화염 속성에 피격 시\n먹잇감 (경장형) : HP가 60%~30%일 경우, 냉기 속성에 피격 시\n먹잇감 (기동형) : HP가 30%~0%일 경우, 전기 속성에 피격 시\n먹잇감 독식 : 공격력 / 적중이 대폭 증가하나 3회 피격 시 해제",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
