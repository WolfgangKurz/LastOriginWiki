export default {
  ...
  "skills": [
    ...
    },
    {
      ...
      "name": "배리어 전개",
      "icon": "Barrier",
      "desc": "피격 시, <배리어 전개 준비> 상태가 되며 3회 중첩인 상태로 피격 시, 배리어가 전개되어 3라운드 동안 피해를 5회 무효화합니다. 배리어가 전개돼있는 동안 피격 시, 해로운 효과를 해제하고 아군이 사망 시, 배리어가 강제로 해제되어 3라운드 동안 받는 피해가 증가합니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
