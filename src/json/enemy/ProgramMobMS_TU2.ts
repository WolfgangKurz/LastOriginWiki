export default {
  ...
  "skills": [
    ...
    {
      "key": "Skill_MP_ProgramMobMS_N_2",
      "name": "다연장 재밍 미사일",
      "icon": "Scan",
      "desc": "재밍 미사일로 {0} 피해를 주고, 대상의 공격력 / 적중 / 치명타를 낮춥니다. 일정 확률로 대상에게 적용된 공격력 강화 효과를 해제합니다.",
      "passive": false,
      "type": 0,
      "target": "enemy",
      "buff": {
    ...
    {
      "key": "Skill_MP_ProgramMobMS_N_4",
      "name": "공격 분석",
      "icon": "SelfSpdBuff",
      "desc": "피격 시, 공격을 분석해 해당 라운드 동안 회피가 증가합니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
