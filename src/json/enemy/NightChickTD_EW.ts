export default {
  ...
  "skills": [
    {
      "key": "Skill_MP_NightChickTD_EW_1",
      "name": "스턴 샷-테스트",
      "icon": "Shock",
    ...
    {
      "key": "Skill_MP_NightChickTD_EW_3",
      "name": "과충전-테스트",
      "icon": "Shock",
      "desc": "에너지 컨덴서의 전기 충격에 맞을 경우, 3라운드 동안 과충전 상태가 되어 공격력 / 적중 / 회피 / AP / 행동력이 크게 증가합니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
    ...
    {
      "key": "Skill_MP_NightChickTD_EW_4",
      "name": "방전-테스트",
      "icon": "Shock",
