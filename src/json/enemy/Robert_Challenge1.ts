export default {
  ...
  "skills": [
    {
      "key": "Skill_MP_Robert_Challenge1_1",
      "name": "약점 분석",
      "icon": "Beam",
          ...
          },
          {
            ...
            "if": {
              "on": {
                "func": "OR",
                "select": [
                  "Effect_MP_Robert_Challenge1_41"
                ],
                "attr": 4
              }
            },
    ...
    {
      "key": "Skill_MP_Robert_Challenge1_2",
      "name": "분석 완료: 활용",
      "icon": "Beam",
      ...
      "buff": {
        ...
        "summon": null,
        "use": {
          "key": "Effect_MP_Robert_Challenge1_41",
          "count": 3
        },
        "dismiss_guard": false,
        "acc_bonus": 0,
          ...
          },
          {
            ...
            "if": {
              "on": {
                "func": "OR",
                "select": [
                  "Effect_MP_Robert_Challenge1_58"
                ],
                "attr": 4
              }
            },
    ...
    {
      "key": "Skill_MP_Robert_Challenge1_3",
      "name": "진화의 요람",
      "icon": "SelfAtkBuff",
    ...
    {
      "key": "Skill_MP_Robert_Challenge1_4",
      "name": "고속 연산",
      "icon": "SelfSpdBuff",
    ...
    {
      "key": "Skill_MP_Robert_Challenge1_5",
      "name": "약점 극복",
      "icon": "SelfAtkBuff",
          ...
          },
          {
            ...
            "if": {
              "on": {
                "target": "self",
                "select": [
                  "Effect_MP_Robert_Challenge1_4",
                  "Effect_MP_Robert_Challenge1_44",
                  "Effect_MP_Robert_Challenge1_45"
                ],
                "stack": 1,
                "attr": 4
              }
          ...
          },
          {
            ...
            "if": {
              "on": {
                "func": "OR",
                "select": [
                  "Effect_MP_Robert_Challenge1_56"
                ],
                "attr": 4
              }
            },
