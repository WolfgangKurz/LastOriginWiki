export default {
  ...
  "skills": [
    ...
    },
    {
      ...
      "name": "공격 대형",
      "icon": "TeamDefBuff",
      "desc": "자신이 중열에 있는 상태로 라운드 개시 시, 범위 내 아군에게 적중 / 행동력을 증가시킵니다. 하지만 중열에 있는 상태에서 전기 공격에 피격 시 2라운드 동안 범위 내 아군의 공격력 / 방어력이 감소합니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
