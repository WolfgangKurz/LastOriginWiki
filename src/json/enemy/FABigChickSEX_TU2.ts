export default {
  ...
  "skills": [
    {
      "key": "Skill_MP_FABigChickSEX_N_1",
      "name": "방패 찍기",
      "icon": "ShieldWall",
    ...
    {
      "key": "Skill_MP_FABigChickSEX_N_2",
      "name": "칙 블로킹",
      "icon": "ShieldWall",
    ...
    {
      "key": "Skill_MP_FABigChickSEX_N_3",
      "name": "칙 방어 지휘",
      "icon": "TeamDefBuff",
    ...
    {
      "key": "Skill_MP_FABigChickSEX_N_4",
      "name": "칙 근성 발동",
      "icon": "SelfDefBuff",
    ...
    {
      "key": "Skill_MP_FABigChickSEX_N_5",
      "name": "거대한 벽",
      "icon": "ShieldWall",
      "desc": "전투 개시 시, 2라운드 동안 자신의 사거리를 감소시킵니다. 라운드 개시 시, 자신에게 표식을 지정하고 자신의 방어력 감소 효과를 해제합니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
