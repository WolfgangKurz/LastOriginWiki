export default {
  ...
  "skills": [
    ...
    {
      "key": "Skill_MP_NestGuardian_N_5",
      "name": "과열",
      "icon": "SelfAtkDeBuff",
      "desc": "스킬을 사용 시, <과열> 상태가 적용됩니다. 라운드 개시 시, <과열> 상태가 3중첩이라면 3라운드 동안 <작동 정지> 상태에 빠져 행동 불능 상태가 되고 해당 상태에서 화염 공격에 피격 시, 3라운드 동안 받는 피해가 증가합니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
