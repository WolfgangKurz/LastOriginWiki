export default {
  ...
  "skills": [
    ...
    },
    {
      ...
      "name": "강습 대열-테스트",
      "icon": "TeamAtkBuff",
      "desc": "자신의 앞에 있는 아군의 공격을 지원하고 자신의 AP가 감소됩니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
    ...
    },
    {
      ...
      "name": "광폭화-테스트",
      "icon": "TeamAtkBuff",
      "desc": "광폭화-매 라운드마다 공격력이 증가하고 추가적으로 5라운드가 되면 명중률, 10라운드에는 치명타 확률, 15라운드에는 행동력이 증가합니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
