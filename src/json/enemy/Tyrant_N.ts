export default {
  "id": "Tyrant_N",
  "name": "타이런트",
  "desc": "이 타이런트들... 예전에 본 기억이 있습니다. 이들의 A.I.는 말 그대로 야생동물에 가깝기 때문에 전술적인 판단은 커녕, 본능에 따라 목표물을 선택할겁니다. 그리고... 거의 항상 두 기가 함께 다니는 것도 조금 신경쓰입니다. ...주인님. 절 믿고 일선에 내보내주시겠습니까? 주인님의 소중한 분들을 지키는 것으로, 주인님이 저희에게 베풀어주신 갚을 수 없는 은혜에 조금이나마 보답하고 싶습니다.\n\n\n-블랙 웜 S9 드림.",
