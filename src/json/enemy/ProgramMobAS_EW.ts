export default {
  ...
  "skills": [
    {
      "key": "Skill_MP_ProgramMobAS_EW_1",
      "name": "스턴 스파이크-테스트",
      "icon": "MultiMissile",
    ...
    {
      "key": "Skill_MP_ProgramMobAS_EW_2",
      "name": "파일 벙커 드라이브-테스트",
      "icon": "Scan",
    ...
    {
      "key": "Skill_MP_ProgramMobAS_EW_3",
      "name": "광폭화-테스트-패트릭",
      "icon": "TeamAtkBuff",
    ...
    {
      "key": "Skill_MP_ProgramMobAS_EW_4",
      "name": "노즐 강화-테스트",
      "icon": "TeamAtkBuff",
    ...
    {
      "key": "Skill_MP_ProgramMobAS_EW_5",
      "name": "전열 돌파-테스트",
      "icon": "SelfDefBuff",
