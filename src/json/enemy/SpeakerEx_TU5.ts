  ...
  "skills": [
    {
      ...
      "name": "사운드 웨이브",
      "icon": "EnemyDetect",
      "desc": "광범위한 음파를 발사해 대상에게 보호 무시 {0} 피해를 주고, 3라운드 동안 공격력 / 치명타 감소 상태로 만들며 일정 확률로 뒤로 1칸 밀어버립니다. 최대 출력 상태일 시, 대상의 AP를 감소시킵니다.",
      "passive": false,
      "type": 0,
      "target": "enemy",
      "buff": {
    ...
    },
    {
      ...
      "name": "사운드 출력 강화",
      "icon": "SelfAtkBuff",
      "desc": "라운드 개시 시, 자신에게 <사운드 출력 강화> 효과가 적용되며 아군이 사망 시, <사운드 출력 강화> 효과가 해제 됩니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
    ...
    },
    {
      ...
      "name": "최대 출력",
      "icon": "SelfSpdBuff",
      "desc": "라운드 개시 시, 2라운드 이하인 상태라면 행동력이 증가합니다. 최대 출력 상태에서 <사운드 웨이브> 스킬을 사용 시, 대상의 AP를 감소시킵니다.",
      "passive": true,
      "type": 0,
      "target": "team",
      "buff": {
