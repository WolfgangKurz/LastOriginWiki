...
export type AICondition = AICondition_Attacked | AICondition_CanUse | AICondition_CanUsePos | AICondition_HP | AICondition_Action |
	AICondition_Cri100 | AICondition_Pos | AICondition_CanMove | AICondition_Exist | AICondition_Buff;
