...
export const WorldIds: string[] = [
	...
	"Ev31", "Ev32", "Ev33", "Ev34", "Ev35", "Ev36", "Ev37", "Ev38",
];
...
export const CurrentEventId = "Ev38";
export const EventFrom = new Date(2026, 5 - 1, 7);
export const EventTo = new Date(2026, 5 - 1, 21);
