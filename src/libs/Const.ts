...
export const PermanentEvents: string[] = ["Ev1", "Ev2", "Ev3"];
export const CurrentEvent = "Ev7";
export const EventFrom = new Date(2021, 10 - 1, 12);
export const EventTo = new Date(2021, 11 - 1, 15);
