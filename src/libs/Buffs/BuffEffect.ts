...
export function BuffEffectList (): Record<BuffEffectListGroupKeys, BuffEffectInfo[]> {
	const dict: Record<BuffEffectListGroupKeys, BuffEffectInfo[]> = {
		stats: [
			{ pm: true, text: LocaleGet("BUFF_ATK"), type: [BUFFEFFECT_TYPE.STAT_ATK_VALUE, BUFFEFFECT_TYPE.STAT_ATK_RATIO] },
			{ pm: true, text: LocaleGet("BUFF_DEF"), type: [BUFFEFFECT_TYPE.STAT_DEF_VALUE, BUFFEFFECT_TYPE.STAT_DEF_RATIO] },
			{ pm: true, text: LocaleGet("BUFF_HP"), type: [BUFFEFFECT_TYPE.STAT_HP_VALUE, BUFFEFFECT_TYPE.STAT_HP_RATIO] },
			{ pm: true, text: LocaleGet("BUFF_ACC"), type: [BUFFEFFECT_TYPE.STAT_RATING_VALUE, BUFFEFFECT_TYPE.STAT_RATING_RATIO] },
			{ pm: true, text: LocaleGet("BUFF_CRIT"), type: [BUFFEFFECT_TYPE.STAT_CRITICAL_VALUE, BUFFEFFECT_TYPE.STAT_CRITICAL_RATIO] },
			{ pm: true, text: LocaleGet("BUFF_EVA"), type: [BUFFEFFECT_TYPE.STAT_AVOID_VALUE, BUFFEFFECT_TYPE.STAT_AVOID_RATIO] },
		],
		damageAdd: [
			{ pm: true, text: LocaleGet("BUFF_ANTI_LIGHT"), type: [BUFFEFFECT_TYPE.STAGE_TROOPERTYPEDMGBONUS_RATIO] },
			{ pm: true, text: LocaleGet("BUFF_ANTI_MOBILITY"), type: [BUFFEFFECT_TYPE.STAGE_ARMOREDTYPEDMGBONUS_RATIO] },
			{ pm: true, text: LocaleGet("BUFF_ANTI_HEAVY"), type: [BUFFEFFECT_TYPE.STAGE_MOBILITYTYPEDMGBONUS_RATIO] },
			{ pm: true, text: LocaleGet("BUFF_DMG_UP_BY_HP"), type: [BUFFEFFECT_TYPE.STAGE_DAMAGEAMP_BYHP_ME] },
			{ pm: true, text: LocaleGet("BUFF_DMG_UP_BY_TARGET_HP"), type: [BUFFEFFECT_TYPE.STAGE_DAMAGEAMP_BYHP_OPP] },
		...
		damageReduce: [
			{ pm: false, text: LocaleGet("BUFF_GET_DMG_DOWN"), type: [BUFFEFFECT_TYPE.STAGE_SHIELD_RATIO] },
			{ pm: false, text: LocaleGet("BUFF_DMG_IMMUNE"), type: [BUFFEFFECT_TYPE.STAGE_IMMUNESHIELD_TIME] },
			{ pm: false, text: LocaleGet("BUFF_DMG_MINIMUM"), type: [BUFFEFFECT_TYPE.STAGE_SHIELD_VALUE] },
			{ pm: false, text: LocaleGet("BUFF_BARRIER"), type: [BUFFEFFECT_TYPE.STAGE_IMMUNESHIELD_VALUE] },
		...
		speedAp: [
			{ pm: true, text: LocaleGet("BUFF_AP"), type: [BUFFEFFECT_TYPE.STAGE_AP_VALUE] },
			{ pm: false, text: LocaleGet("BUFF_AP_SHIFT"), type: [BUFFEFFECT_TYPE.STAGE_AP_SHIFT] },
			{ pm: true, text: LocaleGet("BUFF_SPEED"), type: [BUFFEFFECT_TYPE.STAT_SPEED_VALUE, BUFFEFFECT_TYPE.STAT_SPEED_RATIO] },
			{ pm: false, text: LocaleGet("BUFF_AP_STOP"), type: [BUFFEFFECT_TYPE.STAGE_AP_STOP] },
			{ pm: false, text: LocaleGet("BUFF_SEAL"), type: [BUFFEFFECT_TYPE.STAGE_SEAL_SKILL] },
		],
		offPierce: [
			{
				pm: false,
				text: LocaleGet("BUFF_OFF_BUFF"),
				type: [
			...
			{ pm: true, text: LocaleGet("BUFF_DEF_PIERCE"), type: [BUFFEFFECT_TYPE.STAGE_DEFPIERCE_RATIO] },
			{ pm: false, text: LocaleGet("BUFF_BARRIER_PIERCE"), type: [BUFFEFFECT_TYPE.BARRIER_PIERCE] },
		],
		resist: [
			...
			{ pm: true, text: LocaleGet("BUFF_RES_DEBUFF"), type: [BUFFEFFECT_TYPE.STAGE_DEBUFF_RATEUP, BUFFEFFECT_TYPE.STAGE_DEBUFF_PERDOWN] },
		],
		damage: [
			{
				pm: false,
				text: LocaleGet("BUFF_ADDDMG_PHYSICS"),
				type: [
			...
			{
				pm: false,
				text: LocaleGet("BUFF_ADDDMG_FIRE"),
				type: [
			...
			{
				pm: false,
				text: LocaleGet("BUFF_ADDDMG_THUNDER"),
				type: [
			...
			{ pm: false, text: LocaleGet("BUFF_DMG_PHYSICS_BY_HP"), type: [BUFFEFFECT_TYPE.STAGE_ICE_DAMAGE_APPLY] },
			{ pm: false, text: LocaleGet("BUFF_DMG_PHYSICS_BY_HP"), type: [BUFFEFFECT_TYPE.STAGE_LIGHTNING_DAMAGE_APPLY] },
		],
		etcBuff: [
			{ pm: false, text: LocaleGet("BUFF_SCOUT"), type: [BUFFEFFECT_TYPE.UI_INFO_NEXTENEMY] },
			{ pm: false, text: LocaleGet("BUFF_COUNTER"), type: [BUFFEFFECT_TYPE.STAGE_REFLECTPHYSICS_RATIO_DEFENDER] },
			{ pm: true, text: LocaleGet("BUFF_CRIT_NEXT"), type: [BUFFEFFECT_TYPE.STAGE_CRITICAL_NEXTATTACK] },
			{ pm: true, text: LocaleGet("BUFF_RANGE"), type: [BUFFEFFECT_TYPE.STAT_RANGE_VALUE] },
			{ pm: false, text: LocaleGet("BUFF_SUPPORT_ATK"), type: [BUFFEFFECT_TYPE.STAGE_SUPPORT_ATTACK] },
			{ pm: true, text: LocaleGet("BUFF_EFFECT_RATE"), type: [BUFFEFFECT_TYPE.STAGE_BUFFEFFECTRATE_CHANGE] },
			{ pm: true, text: LocaleGet("BUFF_EXP"), type: [BUFFEFFECT_TYPE.STAGE_EXP_UP] },
			{
				pm: false,
				text: LocaleGet("BUFF_TOGETHER"),
				type: [
		...
		etcDebuff: [
			{ pm: false, text: LocaleGet("BUFF_MARKING"), type: [BUFFEFFECT_TYPE.STAGE_MARKING] },
			{ pm: false, text: LocaleGet("BUFF_PROVOKE"), type: [BUFFEFFECT_TYPE.STAGE_PROVOKE] },
			{ pm: false, text: LocaleGet("BUFF_SNARE"), type: [BUFFEFFECT_TYPE.STAGE_SNARE] },
			{ pm: false, text: LocaleGet("BUFF_MOVE_BACK"), type: [BUFFEFFECT_TYPE.STAGE_MOVE_BACK] },
			{ pm: false, text: LocaleGet("BUFF_MOVE_FRONT"), type: [BUFFEFFECT_TYPE.STAGE_MOVE_FRONT] },
			{ pm: false, text: LocaleGet("BUFF_SUMMON_INSTENV"), type: [BUFFEFFECT_TYPE.REMOVE_SUMMON_INSTENV] },
		],
	};
	return dict;
}
